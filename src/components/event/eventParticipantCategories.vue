  ...
  <v-sheet v-if="pModel">
    <v-row dense>
      <v-col>
        ...
        <p><v-btn small
          :text="arrayEquals(event.age_style_used, age_style_choices.EAF)"
          @click="event.age_style_used=age_style_choices.EAF">EAF</v-btn> - for Estonian Archery Federation. See table <a href="http://www.vibuliit.ee/uus/wp-content/uploads/2021/02/vanuseklassid.pdf" target="_blank">here</a></p>
      </v-col>
      <v-col>
      <v-treeview
  ...
  export default {
    ...
    data: () => ({
      age_style_choices: {
        ...
        'EAF': [
          'U13|R', 'U13|C', 'U13|B', 'U13|L',
          'U15|R', 'U15|C', 'U15|B', 'U15|L',
          'U18|R', 'U18|C', 'U18|B', 'U18|L',
          'U21|R', 'U21|C', 'U21|B', 'U21|L',
          'A|R', 'A|C', 'A|B', 'A|L',
          '50+|R', '50+|C', '50+|B', '50+|L',
        ],
      },
